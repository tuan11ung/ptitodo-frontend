  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        cards: [
          /**
           * Fix bug khong keo duoc vao column rong:
           * Phia FE se tao 1 card dac biet
           * card nay se bi an o giao dien UI
           * Cau truc ID cua card nay de Unique rat don gian, khong can lam random
           * moi column chi co toi da 1 placeholder card
           */
